    ...
    <div class="container">
        <div class="row main-content">
            ...
            <div class="row">
                <div class="col-xs-12 col-md-6 mt-4">
                    <div class="card home-card">
                        <a class="card-block stretched-link text-decoration-none" href="{{ route('mod.index', ['mod_type' => 'track']) }}">
                ...
                <div class="col-xs-12 col-md-6 mt-4">
                    <div class="card home-card">
                        <a class="card-block stretched-link text-decoration-none" href="{{route('mod.index', ['mod_type' => 'vehicle'])}}">
            ...
            <div class="row">
                <div class="col-xs-12 col-md-6 mt-4">
                    <div class="card home-card">
                        <a class="card-block stretched-link text-decoration-none" href="{{route('mod.index', ['mod_type' => 'other'])}}">
